 ...
 <div class="container-fluid btn-right">
    ...
    <div>
        <table>
            <thead>
                <tr>
                    <th>ID</th><th>Description</th><th>Teacher's Id</th><th>Delete</th><th>Update</th>
                </tr>
            </thead>
            ...
            <tbody>
                <c:forEach var="course" items="${courses}">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath }/search/studentsnotincourse?courseId=${course.id}">Add Students</a></td>
                        <td><a href="${pageContext.request.contextPath }/search/studentsbycourse?courseId=${course.id}">Remove Students</a></td>
                    </tr>
                </c:forEach>
