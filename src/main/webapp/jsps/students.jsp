            ...
            <tbody>
                <c:forEach var="student" items="${students}">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath }/search/coursesnotinstudent?studentId=${student.id}">Add Course</a></td>
                        <td><a href="${pageContext.request.contextPath }/search/coursesbystudent?studentId=${student.id}">Remove Course</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
