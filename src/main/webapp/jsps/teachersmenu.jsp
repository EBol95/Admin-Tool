 ...
 <div class="container-fluid btn-right">
    ...
    <div class="center">
        <div class="search-wrapper">
            ...
            <div class="bot-gap">
                <form method="GET" action="${pageContext.request.contextPath}/search/teacher">
			...
			<div class="insert-wrapper">
				...
				<div class="bot-gap">
            		<form method="post" action="${pageContext.request.contextPath}/insert/teacher">
