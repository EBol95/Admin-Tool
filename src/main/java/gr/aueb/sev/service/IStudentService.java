...
public interface IStudentService {
	/**
	 * Inserts a {@link Student} based on the data carried by the P{@link Student}
	 * 
	 * @param studentsDTO
	...
	/**
	 * Deletes {@link Student} based on the data carried by the P{@link StudentDTO}
	 * 
	 * @param studentDTO
	 * 			DTO object that contains the data.
	 * @throws SQLException
	...
	/**
	 * Updates a {@link Student} based on the data carried by the P{@link StudentDTO} of the new student
	 * 
	 * @param oldStudentDTO
